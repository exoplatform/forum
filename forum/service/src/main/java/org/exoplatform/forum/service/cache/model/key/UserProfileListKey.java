...
public class UserProfileListKey extends ScopeCacheKey {
  ...
  public UserProfileListKey(UserProfileFilter filter, int offset, int limit) {
    this.filter = filter;
    this.offset = offset;
    this.limit = limit;
  }
  ...
  public boolean equals(Object o) {
    if (this == o)
      return true;
    if (!(o instanceof UserProfileListKey))
      return false;
    if (!super.equals(o))
      return false;

    UserProfileListKey that = (UserProfileListKey) o;
