 ...
 * @since 1.2.3
 */
public class ForumMockHttpServletRequest extends MockHttpServletRequest {
   ...
   */
  public ForumMockHttpServletRequest(String url, InputStream data, int length, String method, Map<String, List<String>> headers) {
