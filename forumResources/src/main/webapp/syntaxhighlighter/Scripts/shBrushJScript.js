...
window.eXo.dp.sh.Brushes.JScript = function()
{
...
window.eXo.dp.sh.Brushes.JScript.prototype	= new window.eXo.dp.sh.Highlighter();
window.eXo.dp.sh.Brushes.JScript.Aliases	= ['js', 'jscript', 'javascript'];
