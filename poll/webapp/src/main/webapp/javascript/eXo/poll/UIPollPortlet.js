var UIPollPortlet = {
  ...
  init : function(elm) {
    ...
    utils.ForumUtils.onResize(UIPollPortlet.onResizeMarkLayer);
  ...
  onResizeMarkLayer : function() {
    utils.ForumUtils.setMaskLayer(UIPollPortlet.portletId);
  },
  ...
  expandCollapse : function() {
    ...
    if (contentContainer.css('display') != 'none') {
      ...
      jobj.attr('class', 'IconRight ExpandButton').attr('title', jobj.attr('expand'));
      forumToolbar.css('borderBottom', 'solid 1px #b7b7b7');
    } else {
      contentContainer.css('display', 'block');
      jobj.attr('class', 'IconRight CollapseButton').attr('title', jobj.attr('collapse'));
      forumToolbar.css('borderBottom', 'none');
    }
  }
};
_module.UIPollPortlet = UIPollPortlet;
